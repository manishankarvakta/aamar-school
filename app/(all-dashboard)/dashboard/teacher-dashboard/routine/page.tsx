...
import { TeacherRoutineClient } from '../_components/teacher-routine-client';
...
export default async function TeacherRoutinePage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh] p-6">
        <div className="text-center space-y-3 border p-8 rounded-xl bg-card shadow-sm max-w-md">
          <h2 className="text-xl font-bold text-red-600">Failed to Load Schedule</h2>
  ...
  return <TeacherRoutineClient data={result.data as any} />;
}
