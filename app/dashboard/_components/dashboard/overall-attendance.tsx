...
const attendanceStats = [
  { label: "No. of Present", value: "12,200", color: "text-green-600" },
  { label: "No. of Absent", value: "200", color: "text-red-600" },
  { label: "Late arrivals", value: "120", color: "text-yellow-600" },
];
